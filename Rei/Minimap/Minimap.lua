...
BgFrame_b:SetVertexColor(unpack(T.Color.RGB.BgColor))
...
ArtFrame_1:SetVertexColor(unpack(T.Color.RGB.Orange))
...
ArtFrame_2:SetVertexColor(unpack(T.Color.RGB.Orange))
...
ArtFrame_3:SetVertexColor(unpack(T.Color.RGB.Orange))
